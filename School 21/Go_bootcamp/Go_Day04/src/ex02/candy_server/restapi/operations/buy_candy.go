...
type BuyCandyHandlerFunc func(BuyCandyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn BuyCandyHandlerFunc) Handle(params BuyCandyParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// BuyCandyHandler interface for that can handle valid buy candy params
type BuyCandyHandler interface {
	Handle(BuyCandyParams, interface{}) middleware.Responder
}
...
func (o *BuyCandyCreatedBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateChange(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateThanks(formats); err != nil {
		res = append(res, err)
	}
...
func (o *BuyCandyCreatedBody) validateChange(formats strfmt.Registry) error {

	if err := validate.Required("buyCandyCreated"+"."+"change", "body", o.Change); err != nil {
		return err
	}
...
func (o *BuyCandyCreatedBody) validateThanks(formats strfmt.Registry) error {

	if err := validate.Required("buyCandyCreated"+"."+"thanks", "body", o.Thanks); err != nil {
		return err
	}
