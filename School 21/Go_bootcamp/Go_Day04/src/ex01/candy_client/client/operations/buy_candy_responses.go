...
func (o *BuyCandyCreated) Error() string {
	...
	return fmt.Sprintf("[POST /buy_candy][%d] buyCandyCreated %s", 201, payload)
}
...
func (o *BuyCandyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /buy_candy][%d] buyCandyBadRequest %s", 400, payload)
}
...
func (o *BuyCandyPaymentRequired) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /buy_candy][%d] buyCandyPaymentRequired %s", 402, payload)
}
