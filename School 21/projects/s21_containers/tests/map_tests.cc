...
TEST(map_constructor, case5) {
  ...
  // s21_tree s21_tree<int, double> s21_tree_int(pair1);
  // s21_tree s21_tree<double, std::string>:: s21_tree_double(pair2);
  // s21_tree s21_tree<std::string, int>:: s21_tree_string(pair3);
...
TEST(map_insertOrAssign, case1) {
  s21::map<double, std::string> s21_map;

  // std::pair<s21::map<double, std::string>::iterator, bool> insert4 =
  s21_map.insert_or_assign(2.77, "hi");
  std::pair<s21::map<double, std::string>::iterator, bool> insert5 =
      s21_map.insert_or_assign(2.77, "hola");
  EXPECT_EQ(insert5.first->second, s21_map[2.77]);
  EXPECT_EQ(s21_map.size(), 1U);
}

TEST(map_insertOrAssign, case2) {
  s21::map<double, std::string> s21_map;

  // std::pair<s21::map<double, std::string>::iterator, bool> insert4 =
  s21_map.insert_or_assign(2.77, "hi");
  std::pair<s21::map<double, std::string>::iterator, bool> insert5 =
      s21_map.insert_or_assign(2.77, "");
  EXPECT_EQ(insert5.first->second, s21_map[2.77]);
  EXPECT_EQ(s21_map.size(), 1U);
}

TEST(set_MaxSize, case1) {
  s21::map<double, int> s21_set;
  std::map<double, int> std_set;
...
TEST(set_MaxSize, case2) {
  s21::map<double, int> s21_set = {
      {22.2, 1}, {44.48, 2}, {12.4457, 3}, {1.44, 4}};
...
TEST(map_begin, case4) {
  ...
  EXPECT_EQ(s21_map.begin().node_, s21_map.end().node_);
}
...
TEST(map_end, case4) {
  s21::map<int, double> s21_map;
  EXPECT_EQ(s21_map.end().node_, nullptr);
}
...
TEST(map_erase, case11) {
  std::pair<int, int> pair1{1, 1};
  std::pair<int, int> pair2{2, 2};
  std::pair<int, int> pair3{3, 3};
  std::pair<int, int> pair4{4, 4};
  std::pair<int, int> pair5{5, 5};
  std::pair<int, int> pair6{6, 6};
  std::pair<int, int> pair7{7, 7};
  std::pair<int, int> pair8{8, 8};
  std::pair<int, int> pair9{9, 9};
  std::pair<int, int> pair10{10, 10};
  s21::map<int, int> s21_map = {{pair1}, {pair2}, {pair3}, {pair4}, {pair5},
                                {pair6}, {pair7}, {pair8}, {pair9}, {pair10}};
  s21::map<int, int> s21_map1 = s21_map;
  s21::map<int, int> s21_map2 = s21_map;

  for (int i = 1; i < 11; i++) {
    auto it = s21_map1.s21_search(i);
    s21_map1.erase(it);
  }

  for (int i = 10; i > 0; i--) {
    auto it = s21_map2.s21_search(i);
    s21_map2.erase(it);
  }

  EXPECT_EQ(s21_map1.size(), 0U);
  EXPECT_EQ(s21_map2.size(), 0U);
...
TEST(map_insert_many, case1) {
  ...
  std::vector<std::pair<s21::map<int, double>::iterator, bool>> insert_many1 =
      s21_map.insert_many(pair1, pair2, pair3, pair4, pair5);

  EXPECT_EQ(insert_many1[0].first->first, 9);
  EXPECT_EQ(insert_many1[0].second, true);
  EXPECT_EQ(s21_map.size(), 3U);
}

TEST(map_insert_many, case2) {
  std::pair<double, std::string> pair1{1.4, "hello"};
  std::pair<double, std::string> pair2{2.77, "hi"};
  std::pair<double, std::string> pair3{3.9, "hola"};
  std::pair<double, std::string> pair4{2.77, "hi"};
  ...
  std::vector<std::pair<s21::map<double, std::string>::iterator, bool>>
      insert_many1 = s21_map.insert_many(pair1, pair2, pair3);

  EXPECT_EQ(insert_many1[0].first->first, 2.77);
  EXPECT_EQ(insert_many1[0].second, true);
  EXPECT_EQ(s21_map.size(), 3U);
}

TEST(map_insert_many, case3) {
  std::pair<std::string, int> pair1{"hello", 1};
  std::pair<std::string, int> pair2{"hi", 2};
  std::pair<std::string, int> pair3{"hi", 2};
  std::pair<std::string, int> pair4{"hola", 3};
  ...
  std::vector<std::pair<s21::map<std::string, int>::iterator, bool>>
      insert_many1 = s21_map.insert_many(pair1, pair2, pair3, pair4, pair5);

  EXPECT_EQ(insert_many1[0].first->first, "hi");
  EXPECT_EQ(insert_many1[0].second, true);
  EXPECT_EQ(s21_map.size(), 3U);
}

TEST(map_insert_many, case4) {
  std::pair<int, double> pair1{9, 1.4};
...
TEST(map_insert_many, case5) {
  std::pair<double, std::string> pair1{1.4, "hello"};

  s21::map<double, std::string> s21_map = {pair1};

  std::vector<std::pair<s21::map<double, std::string>::iterator, bool>>
      insert_many1 = s21_map.insert_many(pair1);

  EXPECT_EQ(insert_many1[0].second, false);
  EXPECT_EQ(s21_map.size(), 1U);
}

TEST(map_insert_many, case6) {
  std::pair<std::string, int> pair1{"hello", 1};
  std::pair<std::string, int> pair2{"hi", 2};
  ...
  std::vector<std::pair<s21::map<std::string, int>::iterator, bool>>
      insert_many1 = s21_map.insert_many(pair2);
