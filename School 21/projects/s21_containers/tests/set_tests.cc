...
TEST(set_begin, case3) {
  ...
  EXPECT_EQ(s21_set.begin()->first, "hello");
}

TEST(set_begin, case4) {
  s21::set<int> s21_set;

  EXPECT_EQ(s21_set.begin().node_, nullptr);
}

TEST(set_begin, case5) {
  s21::set<double> s21_set = {1.4, 1.4};

  EXPECT_EQ(s21_set.begin()->first, 1.4);
}
...
TEST(set_end, case1) {
  ...
  EXPECT_EQ((--s21_set.end())->first, 23);
}

TEST(set_end, case2) {
  s21::set<double> s21_set = {11.4, 2.770001, 3.901, 11.400000001, 3.9};

  EXPECT_EQ((--s21_set.end())->first, 11.400000001);
}
...
TEST(set_end, case3) {
  ...
  EXPECT_EQ((--s21_set.end())->first, "hola-hola");
}

TEST(set_end, case4) {
  s21::set<int> s21_set;

  EXPECT_EQ(s21_set.end().node_, nullptr);
}

TEST(set_end, case5) {
  s21::set<double> s21_set = {1.4, 1.4};

  EXPECT_EQ((--s21_set.end())->first, 1.4);
}

TEST(set_end, case6) {
  s21::set<std::string> s21_set = {"hello", "hello", "hello"};

  EXPECT_EQ((--s21_set.end())->first, "hello");
}

TEST(set_balance, case1) {
  s21::set<int> s21_set = {1, 15, 5};

  EXPECT_EQ((--s21_set.end())->first, 15);
  EXPECT_EQ(s21_set.size(), 3U);
}
...
TEST(set_balance, case2) {
  ...
  EXPECT_EQ((--s21_set.end())->first, 11.4);
  EXPECT_EQ(s21_set.size(), 3U);
}
...
TEST(set_balance, case4) {
  ...
  EXPECT_EQ((--s21_set.end())->first, 1543);
  EXPECT_EQ(s21_set.begin()->first, 5);
  EXPECT_EQ(s21_set.size(), 5U);
}
...
TEST(set_balance, case5) {
  ...
  EXPECT_EQ((--s21_set.end())->first, 60);
...
TEST(set_erase, case1) {
  ...
  it++;
  s21_set.erase(it);
  EXPECT_EQ(s21_set.begin()->first, 4);
  EXPECT_EQ((--s21_set.end())->first, 18);
  ...
  s21_set.erase(it);
  EXPECT_EQ(s21_set.begin()->first, 5);
  EXPECT_EQ((--s21_set.end())->first, 16);
  EXPECT_EQ(s21_set.size(), 3U);
...
TEST(set_erase, case3) {
  ...
  auto it = --s21_set.end();
  s21_set.erase(it);
  EXPECT_EQ((--s21_set.end())->first, "hola");
  EXPECT_EQ(s21_set.size(), 4U);

  it = --s21_set.end();
  s21_set.erase(it);
  EXPECT_EQ((--s21_set.end())->first, "hi");
  EXPECT_EQ(s21_set.size(), 3U);
...
TEST(set_erase, case4) {
  ...
  ++it;
  ++it;
  EXPECT_EQ((--s21_set.end())->first, 44.48);
  EXPECT_EQ(s21_set.size(), 3U);
}
...
TEST(set_swap, case1) {
  ...
  EXPECT_EQ(s21_set_ref.begin()->first, 1.44);

  EXPECT_EQ(s21_set_res.size(), 2U);
  EXPECT_EQ(s21_set_res.begin()->first, 22.2);
}
...
TEST(set_find, case1) {
  ...
  EXPECT_EQ(s21_set.find(23.4).node_, nullptr);
}
...
TEST(set_find, case2) {
  ...
  auto it = s21_set.begin();
  ++it;
  EXPECT_EQ(s21_set.find(12.4457)->first, it->first);

  it--;
  EXPECT_EQ(s21_set.find(1.44)->first, it->first);

  it += 2;
  EXPECT_EQ(s21_set.find(22.2)->first, it->first);
}
...
TEST(set_insert_many, case1) {
  ...
  EXPECT_EQ(insert_many1[0].first->first, 23);
